...
class Registry
{
  ...
  public:
    ...
    void           separatorchar(CString sepchar);
    ...
    BOOL           includeEnvRealIpAddress();
    void           includeEnvRealIpAddress(BOOL ipaddress);
    ...
    CString        envRealIpAddress();
    void           envRealIpAddress(CString ipaddress);
    ...
    BOOL           includeCmdRealIpAddress();
    void           includeCmdRealIpAddress(BOOL ipaddress);
    ...
    CString        cmdRealIpAddress();
    void           cmdRealIpAddress(CString ipaddress);
